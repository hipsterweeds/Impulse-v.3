...
* Linux:
  ...
  * `git clone https://github.com/hipsterweeds/Impulse-v.3.git`
  * `cd Impulse/`
...
```python3 impulse.py --method SMS --time 20 --threads 15 --target (phone number with + region code)```

<p align="center">
  <img src="https://i.ibb.co/9T0PVzz/Screen-Shot-2020-09-24-at-14-03-58.png">
</p>
